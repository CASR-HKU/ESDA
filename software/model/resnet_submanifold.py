...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.maxpool = ME.MinkowskiMaxPooling(kernel_size=3, stride=2, dimension=2)
        ...
        self.parse_rnn(cfg["rnn"], 512 * block.expansion)
...
def _resnet(
    ...
    model = ResNet(args, block, layers, )
    return model


def resnet18_submanifold(args) -> ResNet:
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], args=args)


def resnet34_submanifold(args) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], args=args)


def resnet50_submanifold(args) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], args=args)
