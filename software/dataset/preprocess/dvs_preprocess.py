...
from dvs.PyAedatTools.ImportAedat import ImportAedat
import dvs.extractdata_uti as uti
import argparse
import pickle
...
if __name__ == "__main__":
    ...
    parser.add_argument('--filter_time', type=int, default=20000)
    ...
    # else:
    OUT_TEST = os.path.join(args.output_dir, 'test')
