...
const ap_int<CFG_BLOCK_1_IW> i_block_1 = {
    #include "data/block_1_i.txt"
};
...
const ap_int<CFG_BLOCK_3_IW> i_block_3 = {
    #include "data/block_3_i.txt"
};
...
const ap_int<CFG_BLOCK_10_IW> i_block_10 = {
    #include "data/block_10_i.txt"
};
...
const ap_int<CFG_BLOCK_13_IW> i_block_13 = {
    #include "data/block_13_i.txt"
};
